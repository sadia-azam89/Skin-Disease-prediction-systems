...
public class SignUp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        user_name=findViewById(R.id.textEmail);
        pass_word=findViewById(R.id.textPass);
        btn2_signup=findViewById(R.id.btnSignUpAcc);
       TextView signin=findViewById(R.id.loginAcc);
